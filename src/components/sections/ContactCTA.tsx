            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a
                  ...
                  className="border border-white/20 hover:border-[#7C6EFA] text-white px-8 py-4 rounded-full font-semibold transition-all duration-200 text-center hover:text-[#7C6EFA]"
                >
